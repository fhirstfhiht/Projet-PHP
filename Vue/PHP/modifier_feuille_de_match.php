...
<?php include('header.php'); ?>
        <section class="section-page">
			<h2 class="title-page">Modifier une Feuille de Match</h2>
		</section>
...
<form method="POST" action="../../Controleur/modifier_feuille.php">
    ...
    <div class="centrer">
        <button type="submit" name="save_changes" value="1" class="btn">Enregistrer les Modifications</button>
        <a href="Feuilles_de_Matchs.php"><button class="btn">Crée une Feuille de Match</button></a>
    </div>
</form>
    <?php else: ?>
